...
## Para correr la simulación desde terminal:

python main.py satelite

#### Se verá lo siguiente: 

[SATELITE] Esperando conexión en localhost:5001...
[SATELITE] Ventana de paso: 120 segundos

[SATELITE] INICIO DE PASADA - Ventana disponible: 120s
           Batería: 100.0% | Temperatura: 25.0°C

Esto inicia el satélite esperando conexión de la terminal terrestre

#### Luego ejecutamos la terminal terrestre con: 

python main.py

#### Se verá lo siguiente: 

[ESTACION]  Conectada al satélite
[PROCEDIMIENTO] Fase 1: ADQUISICION
                Señal adquirida OK

[PROCEDIMIENTO] Condiciones OK - Activando payload
[PROCEDIMIENTO] Descargando datos (500MB)...

  [  0] NOMINAL  | Payload  ON | Datos: 500MB
  Bat:  ████████████████████ 100.0% (NORMAL)
  Temp: ███░░░░░░░░░░░░░░░░░  25.0°C

#### Al final de los 120 segundos:

 FIN DE PASADA. Datos pendientes: 350MB

======================================================================
RESUMEN DE PASADA
======================================================================
Batería:      100.0% → 94.5% (consumo: 5.5%)
Temperatura:  Máx 38.2°C
Datos desc.:  150MB
Duracion:     120s
